...
export default {
  ...
  methods: {
    ...
    setData() {
      ...
      //当前在线
      this.setOnline();
      // 分区真实稿件：动画 / 音乐 / 舞蹈（含各子分区）
      this.setDynamicRegion({ id: 0, ps: 10, rid: 1 });
      this.setDynamicRegion({ id: 3, ps: 10, rid: 3 });
      this.setDynamicRegion({ id: 4, ps: 10, rid: 129 });
    },
    videotest() {
