...
系统基于 MySQL 8.0 InnoDB（utf8mb4），GORM AutoMigrate 首次启动自动建表，共计 **83 张数据表**，按 14 个业务模块组织。
...
| E-R 图 | 说明 |
|--------|------|
| ![完整 ER 图](docs/images/er-diagram-full.png) | **83 实体 · Crow's Foot 标注 · Figma 风格** — [交互版](docs/cakecake_er_figma-diagram.html) |
...
| [cakecake_er_bento.html](docs/cakecake_er_bento.html) | **Bento 风格** 数据库架构总览（83 实体 / 14 模块） |
